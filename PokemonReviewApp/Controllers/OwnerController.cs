...
namespace PokemonReviewApp.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        public IActionResult CreateOwner([FromQuery] int countryId, [FromBody] OwnerDto ownerCreated)
        {
            ...
            var owner = _ownerRepository.GetOwners().FirstOrDefault(c => c.FirstName.Trim().ToUpper() == ownerCreated.FirstName.Trim().ToUpper());
        ...
        public IActionResult UpdateOwner(int ownerId, [FromBody] OwnerDto ownerUpdated)
        {
            ...
            {
                ModelState.AddModelError("", "Somthing went wrong while updating owner");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteOwner(int ownerId)
        {
            ...
            {
                ModelState.AddModelError("", "Somthing went wrong deleting owner");
            }
